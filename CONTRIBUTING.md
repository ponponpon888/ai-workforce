...
3. **Ports** — a POSIX `pull-all`, corrections to the MySQL/SQLite rules in `guard-sql` from
   someone who actually runs those engines, more per-project `CLAUDE.md` templates.
